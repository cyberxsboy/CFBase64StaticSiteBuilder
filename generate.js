...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sponsor-banner { text-align: center; margin: 20px 0; padding: 10px; background: var(--card); border: 1px dashed #cbd5e1; border-radius: 8px; }
        .sponsor-banner img { max-width: 100%; height: auto; border-radius: 4px; }
        .sponsor-banner p { font-size: 0.8em; color: #64748b; margin-bottom: 5px; }
...
`;
        ...
        for (let i = 0; i < pageItems.length; i++) {
            ...
            if ((i + 1) % 4 === 0) {
                htmlContent += `            <div class="sponsor-banner">
                <p>— 赞助广告 —</p>
                <a href="${adLink}" target="_blank" rel="nofollow">
                    <img src="./public/${currentAdImageName}" alt="Sponsor Image">
                </a>
            </div>\n`;
                adCount++;
            }
