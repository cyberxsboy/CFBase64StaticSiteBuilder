...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ad { text-align: center; margin: 20px 0; padding: 10px; background: var(--card); border: 1px dashed #cbd5e1; border-radius: 8px; }
        .ad img { max-width: 100%; height: auto; border-radius: 4px; }
        .ad p { font-size: 0.8em; color: #64748b; margin-bottom: 5px; }
